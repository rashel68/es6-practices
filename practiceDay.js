...
const products = {
    laptop: 'HP', price: 35000, color: 'black',
    phone: {
        brand: 'Samsung', price: 15000, color: 'silver'
    }
}
const product = `Laptop Brand ${products.laptop}, Price = ${products.price} || Phone Price = ${products.phone.price}`;
// console.log(product);
...
const divisionOut = division(20);
// console.log(divisionOut);


/*
৩.২ তুমি দুইটা প্যারামিটার ওয়ালা একটা অ্যারো ফাংশন লিখবে। সেই ফাংশনের ভিতরে কাজ হবে। প্রত্যেকটা ইনপুট প্যারামিটার এর সাথে ২ যোগ করবে তারপর যোগফল দুইটা গুণ করবে। ক্যামনে করবে সেটা চিন্তা করে বের করার চেষ্টা করো */

const sumMultiplication = (num1, num2) => (num1 + 2) * (num2 + 2);
const sumMulOut = sumMultiplication(3, 2);
// console.log(sumMulOut);
...
// console.log(multiplication(2, 3, 2));
...
const mlNumber = number.map(x => x * 5);
// console.log(mlNumber);

/*
৬.[চ্যালেঞ্জিং। গুগলে সার্চ দিয়ে বের করো] অনেকগুলা সংখ্যার একটা array থেকে শুধু বিজোড় সংখ্যা বের করে নিয়ে আসার জন্য filter ইউজ করো */
const numContainer = [5, 2, 4, 6, 8, 5, 7, 9, 14, 11];
const getOdd = numContainer.filter(x => x % 2);
// console.log(getOdd);
...
const pro = productShop.find(product => product.price <= 5000);
// console.log(pro);
...
const arrayContainer = ['Minhaj', 'Tamjid', 'Rokib'];
// const C = arrayContainer[2];
const [, , C] = arrayContainer;
// console.log(C);


/* ১০.তিনটা প্যারামিটার ওয়ালা একটা ফাংশন লিখবে। যেই ফাংশনের কাজ হবে তিনটা প্যারামিটার নিয়ে সেই তিনটা প্যারামিটার এর যোগ করে যোগফল রিটার্ন করবে। আর থার্ড প্যারামিটার এর একটা ডিফল্ট ভ্যালু থাকবে। সেটা হবে ৭।  */

const three = (n1, n2, n3 = 7) => {
    total = n1 + n2 + n3;
    return total;
}
